...
class Options extends Controller {
	...
	function general()
	{
		...
		$rules['wikiname'] = 'trim|max_length[300]|xss_clean'; //We don't require this since the page can be empty.
		$rules['defaultwikipage'] = 'trim|required|max_length[200]'; //Add page name check here
		$this->validation->set_rules($rules);
		
		//Also repopulate the form
		$fields['wikiname'] = 'Wiki title';
		$fields['defaultwikipage'] = 'Default wiki page';
