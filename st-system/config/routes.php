...
$route['(['.$this->config->item('permitted_uri_chars').']+)'] = $route['default_controller']."/$1";
//$route['(.+)'] = $route['default_controller']."/$1";
//$route['(['.$this->config->item('permitted_uri_chars').']+)/(['.$this->config->item('permitted_uri_chars').']+)'] = "$2/$1";
$route['(['.$this->config->item('permitted_uri_chars').']+)/(['.$this->config->item('permitted_uri_chars').']+)'] = "$2/$1";
//$route['(.+)/(.+)'] = "$2/$1";
