...
|
*/
$config['base_url']	= "http://local.suppletext.org/suppleText_CI/";
...
|
*/
$config['permitted_uri_chars'] = 'A-Za-z 0-9~%.:_-'; //Added Capital letters for Wiki.
...
|
*/
$config['encryption_key'] = "suppleText"; //We shouldn't depend on this though.
