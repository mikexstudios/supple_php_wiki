...
|
*/
	$application_folder = "st-system/install";
...
define('ABSPATH', realpath(dirname($_SERVER['SCRIPT_FILENAME']).'/../../').'/'); //A weird hack for URL Rewriting...

if (is_dir(ABSPATH.$application_folder)) //Had to add ABSPATH here.
{
	define('APPPATH', realpath(ABSPATH.$application_folder).'/'); 
}
else
{
